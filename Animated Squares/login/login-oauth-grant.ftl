            ...
            <ul>
                <#if oauth.clientScopesRequested??>
                    <#list oauth.clientScopesRequested as clientScope>
                        ...
                        <li1>
                            <span>${advancedMsg(clientScope.consentScreenText)}</span><br>
                        </li1>
            ...
            <form class="form-actions" action="${url.oauthAction}" method="POST" style="margin-top:25px">
                ...
                <div >
                    ...
                    <div id="kc-form-buttons" style="margin-left:25px; margin-top:20px">
                        ...
                        <p style="font-size:12px;">To Understand fully how HiPaaS will your data, please read the app's <a href="https://google.com">Privacy Policy</a> and <a href="https://facebook.com">Tearms and Conditions.</a></p>
                        </div>
                    </div>
                </div>
            </form>
